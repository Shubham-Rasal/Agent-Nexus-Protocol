/**
 * Implementation of the Lead Qualification tool
 * Evaluates if a lead is qualified based on having contact information
 */
export async function leadQualifierTool(params: { 
  leadInfo: {
    email?: string;
    linkedIn?: string;
    gitHub?: string;
