...
// Tool: Create Entity
server.tool("create_entity", "Create a new entity in the knowledge graph", {
    entity: z.object({
...
server.tool("search_external_kg", "Search for entities in external knowledge graphs", {
...
server.tool("import_external_entity", "Import an entity and its relations from an external knowledge graph", {
    source: z.enum(["wikidata", "dbpedia", "openalex"]),
...
// Tool: Export Graph
server.tool("export_graph", "Export the knowledge graph to JSON-LD and optionally publish to IPFS", {
    options: z.object({
...
// Tool: Get Provenance
server.tool("get_provenance", "Get provenance information for the knowledge graph", {}, async () => {
